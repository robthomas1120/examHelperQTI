/**
 * QTI Export for Item Bank
 * Converts selected questions to QTI format and packages as a zip file
 */
        ...
        try {
            ...
            if (itemXml) {
                this.itemsXML.push({
                    id: questionId,
                    xml: itemXml,
                    title: questionText.substring(0, 50) || `Question ${this.questionCounter}`,
                    type: questionType
                });
            }
        } catch (error) {
